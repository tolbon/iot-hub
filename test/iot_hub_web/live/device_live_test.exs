defmodule IotHubWeb.DeviceLiveTest do
  use IotHubWeb.ConnCase

  import Phoenix.LiveViewTest
  import IotHub.DevicesFixtures

  @create_attrs %{name: "some name", last_seen_at: "2025-04-03T20:54:00Z"}
  @update_attrs %{name: "some updated name", last_seen_at: "2025-04-04T20:54:00Z"}
